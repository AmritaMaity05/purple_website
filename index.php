...
// Assuming you have stored the user's name in the session after login
...
<div class="super_container">
        ...
        <div class="hamburger_menu_content text-right">
            <ul class="menu_top_nav">
                ...
                <li class="menu_item has-children">
                    <a href="#">
                        <?php echo isset($_SESSION['currency']) ? strtoupper($_SESSION['currency']) : 'USD'; ?>
    ...
    <div class="container">
        <div class="deal_of_the_week_header">
            <h2>Deal of the Week</h2>
            <p>Best Deals On Product This Week</p>
        </div>
        <div class="deal_of_the_week_body">
            <div class="deal_image">
                <img src="images/deal_image.png" alt="Deal of the Week">
            </div>
            <div class="deal_timer">
                <ul class="timer">
                    <li><span id="day">0</span><p>Days</p></li>
                    <li><span id="hour">00</span><p>Hours</p></li>
                    <li><span id="minute">00</span><p>Minutes</p></li>
                    <li><span id="second">00</span><p>Seconds</p></li>
                </ul>
            </div>
            <a href="categories.php" class="shop_now_button">Shop Now</a>
        </div>
    </div>
</section>
